...
public class TestGun : MonoBehaviour
{
    ...
    public Transform guns_transfrom;
    void Awake()
    {
    ...
    void RotationGun()
    {
        ...
        rotationDeltaY = currentYRotation - rotationLastY;
        rotationDeltaX = currentCameraXRotation - rotationLastX;

        rotationLastY = currentYRotation;
        rotationLastX = currentCameraXRotation;
        ...
        gunWeightX = Mathf.SmoothDamp(gunWeightX, currentCameraXRotation, ref velocityGunRotate.x, rotationLagTime);
        gunWeightY = Mathf.SmoothDamp(gunWeightY, currentYRotation, ref velocityGunRotate.y, rotationLagTime);
        ...
        guns_transfrom.localRotation = Quaternion.Euler((angularVelocityX * forwardRotationAmount.x), (angularVelocityY * forwardRotationAmount.y), 0);
    }
    void Update()
    {
